...
videoDir=/cygdrive/z/PROCESSforINGEST/1995300_FILM
tnDir=/cygdrive/z/PROCESSforINGEST/1995300_FILM
...
for i in $videoDir/*.mp4; do
    ...
    if [ -f "$i" ] && [ ! -f "$tnDir/$vid.jpg" ]; then
		...
		output=`ffmpeg -itsoffset -2 -ss $ss -i "${i}" -vcodec mjpeg -vframes 1 -s 480x350 -an -f rawvideo "${tnDir}/${vid}.jpg"`;
